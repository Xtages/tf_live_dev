  ...
  "Statement": [
    {
      ...
      "Action": "SNS:Publish",
      "Resource": "arn:aws:sns:us-east-1:605769209612:scalein-staging-topic"
    }
  ]
}
EOF
  ...
  "Statement": [
    {
      ...
      "Action": "SNS:Publish",
      "Resource": "arn:aws:sns:us-east-1:605769209612:ecs-steady-state-topic"
    }
  ]
}
EOF
  ...
  "Statement": [
    {
      ...
      "Action": "SNS:Publish",
      "Resource": "arn:aws:sns:us-east-1:605769209612:deployment-updates-topic"
    }
  ]
}
EOF
